...
var tests = [
  {
    ...
    expected: 'a { background: url("/app/image.jpg") }',
    options: {}
  },
  {
  ...
  },
  {
    ...
    expected: 'li { list-style-image: url("/app/image.jpg") }',
    options: {}
  },
  {
  ...
  },
  {
    ...
    expected: '@import url("/app/funny-little-kittens.css")',
    options: { atRules: true }
  },
  {
    message:
      "should not match url in @import when atRules: false (default value)",
...
function process(css, mapfunc, options) {
  return postcss(plugin(mapfunc, options)).process(css).css;
}
...
test(name, function(t) {
  ...
  tests.forEach(function(test) {
    t.equal(
      process(test.actual, urlMapper, test.options),
      test.expected,
      test.message
    );
  });
