...
const tests = [
  ...
  {
    message: "should match mask with variable",
    actual: 'li { mask: url("image.jpg") }',
    expected: 'li { mask: url("/app-mask/image.jpg") }'
  },
  {
    message: "should match mask with variable",
    actual: 'li { -webkit-mask: url("image.jpg") }',
    expected: 'li { -webkit-mask: url("/app--webkit-mask/image.jpg") }'
  },
  {
